 ...
 <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
    ...
    <script type="text/javascript">
        ...
        function checkAfterSubmit() {
            lengthOfPassword = document.getElementById('password').value;
            lengthOfVerifyPassword = document.getElementById('passwordVerify').value;
            ...
            if(validate){
                if(document.getElementById('password').value != document.getElementById('passwordVerify').value){
                 ...
                 }else if(lengthOfPassword.length < 8 && lengthOfPasswordVerify.length < 8){
                     document.getElementById('errorLogin').innerHTML = 'Passwords need to be 8 characters long';
                 }
                else{
...
<div class="container">
  <div class="row"> 
    ...
    <input type = "password" pattern=".{8,}"   required title="8 characters minimum" placeholder="Password" name = "password" id = "password" onkeyup = "check()" required>
    <input type = "password" pattern=".{8,}"   required title="8 characters minimum" placeholder = "Enter Password again" name = "passwordVerify" id = "passwordVerify" onkeyup = "check()" required>
